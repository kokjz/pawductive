...
@Suite struct UserStatsTests {
    ...
    @Test @MainActor func testAchievementUnlocks() {
        let stats = UserStats()
        let pet = Pet(background: Background(name: "Room", imageName: "room"))
        #expect(Achievement.OneTaskAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.FiveTasksAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.TenTasksAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.OneMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.ThirtyMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.OneHourAchievement.isUnlocked(stats: stats, pet: pet) == false)
        
        stats.totalTasksCompleted = 1
        #expect(Achievement.OneTaskAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.FiveTasksAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.TenTasksAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.OneMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.ThirtyMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        ...
        #expect(Achievement.OneTaskAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.FiveTasksAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.TenTasksAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.OneMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.ThirtyMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.OneHourAchievement.isUnlocked(stats: stats, pet: pet) == false)
        ...
        #expect(Achievement.OneTaskAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.FiveTasksAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.TenTasksAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.OneMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.ThirtyMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.OneHourAchievement.isUnlocked(stats: stats, pet: pet) == false)
        ...
        #expect(Achievement.FiveTasksAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.TenTasksAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.OneMinAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.ThirtyMinAchievement.isUnlocked(stats: stats, pet: pet) == false)
        #expect(Achievement.OneHourAchievement.isUnlocked(stats: stats, pet: pet) == false)
        ...
        #expect(Achievement.TenTasksAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.OneMinAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.ThirtyMinAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.OneHourAchievement.isUnlocked(stats: stats, pet: pet) == false)
        ...
        #expect(Achievement.OneMinAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.ThirtyMinAchievement.isUnlocked(stats: stats, pet: pet) == true)
        #expect(Achievement.OneHourAchievement.isUnlocked(stats: stats, pet: pet) == true)
